...
/** MSG91 mobile OTP is 4 digits; email OTP stays 6 digits. */
export const MOBILE_OTP_LENGTH = 4;
export const EMAIL_OTP_LENGTH = 6;
export const DEV_OTP_MOBILE = '1234';
export const DEV_OTP_EMAIL = '123456';

export function otpLengthForChannel(channel: OtpChannel) {
  return channel === OtpChannel.MOBILE ? MOBILE_OTP_LENGTH : EMAIL_OTP_LENGTH;
}

export function devOtpForChannel(channel: OtpChannel) {
  return channel === OtpChannel.MOBILE ? DEV_OTP_MOBILE : DEV_OTP_EMAIL;
}
