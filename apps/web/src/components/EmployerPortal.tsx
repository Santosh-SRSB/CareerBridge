  ...
  return (
    <header className="ep-deskbar">
      ...
      <div className="ep-deskbar__right">
        <button type="button" className="ep-deskbar__bell" aria-label="Notifications">
          <svg viewBox="0 0 24 24" fill="none" aria-hidden>
            <path
        ...
        <div className="ep-deskbar__user">
          ...
          <button type="button" className="ep-deskbar__avatar" onClick={onSignOut} title="Sign out">
