...
import { HUMAN_INTERVIEWER, humanInterviewRoleFromPassport } from '@careerbridge/shared';
      ...
      <div className="cb-hire is-wide">
        ...
        <div className="cb-hire-stage">
          <aside className="cb-hire-hero">
            ...
            <p>Pick a slot</p>
            <b>I’ll hold your interview time.</b>
          ...
          {loading ? (
            ...
            <form onSubmit={onSubmit} className="cb-hire-card">
              ...
              <p className="cb-hire-note">Interviewer invite goes to {HUMAN_INTERVIEWER.email}.</p>
